...
Reference full template: `/root/projects/react/BuildingPersonalApp/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/root/projects/react/BuildingPersonalApp/.claude/get-shit-done/templates/state.md`.
