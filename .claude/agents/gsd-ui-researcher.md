...
Use template from `/root/projects/react/BuildingPersonalApp/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/root/projects/react/BuildingPersonalApp/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/root/projects/react/BuildingPersonalApp/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
