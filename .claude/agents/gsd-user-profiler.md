...
<reference>
@/root/projects/react/BuildingPersonalApp/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/root/projects/react/BuildingPersonalApp/.claude/get-shit-done/references/user-profiling.md` to load:
