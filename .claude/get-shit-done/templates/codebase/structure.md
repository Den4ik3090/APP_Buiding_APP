...
- Usage: Reference from command with `@/root/projects/react/BuildingPersonalApp/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /root/projects/react/BuildingPersonalApp/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /root/projects/react/BuildingPersonalApp/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
