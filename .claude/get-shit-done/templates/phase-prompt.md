...
<!-- For checkpoint task examples and patterns, see @/root/projects/react/BuildingPersonalApp/.claude/get-shit-done/references/checkpoints.md -->
...
See `/root/projects/react/BuildingPersonalApp/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/root/projects/react/BuildingPersonalApp/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/root/projects/react/BuildingPersonalApp/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
