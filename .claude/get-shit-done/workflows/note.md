...
- **Global scope**: `/root/projects/react/BuildingPersonalApp/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/root/projects/react/BuildingPersonalApp/.claude/notes/`)
...
2. Glob `/root/projects/react/BuildingPersonalApp/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/root/projects/react/BuildingPersonalApp/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/root/projects/react/BuildingPersonalApp/.claude/notes/` — works in any directory
