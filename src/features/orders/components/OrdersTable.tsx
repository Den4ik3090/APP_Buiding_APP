...
const getComparableValue = (order: OrderRow, field: string): string | number => {
  switch (field) {
    case "creation_date":
...
const compareOrders = (leftOrder: OrderRow, rightOrder: OrderRow, field: string, direction: string) => {
...
const resolveDocumentHref = (documentUrl: string | undefined): string => {
...
const getDownloadFileName = (documentUrl: string | undefined, orderNumber: string | undefined): string => {
