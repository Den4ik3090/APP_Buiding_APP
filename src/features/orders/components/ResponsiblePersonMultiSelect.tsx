...
interface ResponsiblePersonMultiSelectProps {
...
function ResponsiblePersonsMultiSelect({
  ...
  disabled = false,
}: ResponsiblePersonMultiSelectProps) {
  ...
  const groupedEmployees = useMemo(() => {
    const groups = new Map<string, RegistryEmployee[]>();
...
export default memo<ResponsiblePersonMultiSelectProps>(ResponsiblePersonsMultiSelect);
