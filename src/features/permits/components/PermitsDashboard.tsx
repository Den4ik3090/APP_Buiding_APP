...
type PermitDashboardItem = Partial<Permit>;

interface PermitsDashboardProps {
  permits: PermitDashboardItem[];
  isLoading?: boolean;
}
...
function PermitsDashboard({ permits, isLoading = false }: PermitsDashboardProps) {
  ...
  const CardContent = ({ children, className }: CardContentProps) => (
    <div className={className ?? styles.cardContent}>{children}</div>
  );
